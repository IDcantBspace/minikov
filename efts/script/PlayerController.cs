...
public partial class PlayerController : CharacterBody2D{
	...
	private void Shoot(){
		...
		//连接子弹信号
		bulletInstance.Connect(
			Bullet.SignalName.BulletHit,
			Callable.From(OnBulletHit)
		);
	}
